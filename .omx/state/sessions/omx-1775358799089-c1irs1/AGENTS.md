...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775358799089-c1irs1 | 2026-04-05T03:13:19.573Z

**Codebase Map:**
  src/: app-shell.test, date, drilldown-style-parity.test, main, rand, render-isolation-architecture.test, repeat-button, runtime-config.test, schema, vite-env.d
  src/collections/: all-assets-activity, asset-activity, assets, cik-quarterly.ready.test, cik-quarterly, compatibility.test, data-freshness, instances, investor-details
  src/components/: DataTable, DuckDBGlobalSearch, InvestorActivityDrilldownDebugTable, InvestorActivityDrilldownTable, LatencyBadge.test, LatencyBadge, ThemeSwitcher, AllAssetsActivityChart, CikValueLineChart, InvestorActivityEchartsChart
  src/db/: schema
  src/hooks/: useContentReady, useRenderTiming
  src/lib/: dexie-db, dexie-persister, architecture.test, architecture, utils
  src/pages/: AssetDetail.sections.test, AssetDetail, AssetsTable, SuperinvestorDetail.sections.test, SuperinvestorDetail, SuperinvestorsTable, UserProfile, search-route-isolation.test
  src/types/: duckdb
  scripts/: benchmark-api-endpoints, benchmark-browser-persistence, benchmark...
